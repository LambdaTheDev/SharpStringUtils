...
namespace SharpStringUtils.Tests.Base64Tests
{
    [TestFixture]
    public class Base64EncoderTests
    {
        ...
        public void BenchmarkSystemEncodeBase()
        {
            ...
            for (int i = 0; i < _bytesToEncode.Length; i++)
            {
                ...
                string y = _encoderNonAlloc.ToBase(_bytesToEncode[i]);
        ...
        public void BenchmarkSystemDecodeBase()
        {
            ...
            for (int i = 0; i < _encodedBytes.Length; i++)
            {
                ...
                ArraySegment<byte> y = _encoderNonAlloc.FromBaseNonAlloc(_encodedBytes[i]);
