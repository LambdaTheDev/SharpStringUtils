...
namespace SharpStringUtils.Tests.StrSplitter
{
    [TestFixture]
    public class StringSpliterTests
    {
        ...
        public void IteratorTest()
        {
            ...
            for (int i = 0; i < _testStrings.Length; i++)
            {
                ...
                foreach (StringSegment segment in new StringSplitterNonAlloc(_testStrings[i], '.'))
                {
                    string entry = BuildString(segment);
